        ...
        function (taRegisterTool, $window, taTranslations, taSelection, taToolFunctions, $sanitize, taOptions, $log, $uibModal) {
            ...
            var checkLink = function (link) {
                ...
                if (link !== null && link !== undefined) {
                    var startingUrl = "http://";
                    var httpsStartingUrl = "https://";
                    return link.indexOf(startingUrl) === 0 || link.indexOf(httpsStartingUrl) === 0 ? link : startingUrl;
                } else {
                    allOk = false;
                }
                return allOk;
            ...
            taRegisterTool('insertLink', {
                ...
                action: function () {
                    ...
                    function replaceSelectedText(replacementText) {
                        ...
                        var end = selection.end.element.lastChild ? selection.end.offset - 1 : selection.end.offset - 1;
